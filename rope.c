...
RopeTree *concat(RopeTree *rt1, RopeTree *rt2) {
    ...
    RopeNode *rt3_root = makeRopeNode(strdup(EMPTY));
...
RopeNode *concat_nodes(RopeNode *rt1, RopeNode *rt2) {
    ...
    RopeNode *rt3 = makeRopeNode(strdup(EMPTY));
...
SplitPair split(RopeTree *rt, int idx) {
    ...
    RopeNode *right_rn = makeRopeNode(strdup(EMPTY));
...
RopeTree *delete (RopeTree *rt, int start, int len) {
    ...
    /* crearea noului rope cu partea dreapta obtinuta
